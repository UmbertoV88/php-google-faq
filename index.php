<?php
    $faq = [
        [
            "domanda" => "Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?<br><br>",
        ...
        [
            "domanda" => "Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?<br><br>",
        ...
        [
            "domanda" => "Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google?<br><br>",
        ...
        [
            "domanda" => "Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web?<br><br>",
